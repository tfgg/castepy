...
parser.add_argument('-n', '--num_cores', type=int, help='Number of cores to use.', default=24)
parser.add_argument('-q', '--queue', type=str, help='SGE queue to use.', default="newpara.q")
